...
public class BaseTest3 {
	...
	{
		capturing(result.getTestContext().getName()+"_"+result.getMethod().getMethodName()+".png");
	}
	@AfterTest
	...
	public void capturing(String img) throws IOException
	{
		Date dt=new Date();
		...
		File dest=new File("./Screen102/"+timestamp+img);
