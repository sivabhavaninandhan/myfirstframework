...
public class dataproviderintotestng {
	WebDriver driver;
	@BeforeClass
	public void setup()
	{
	...
	@Test(dataProvider="getdata",dataProviderClass=dataprovidere_day01.class)
	
	public void verification(String usnm,String pswd)
	{
